...
include("sdk:figma:converter")
include("sdk:core:extensions")
include("sdk:core:tree")
include("sdk:core:xml")
include("sdk:generator:kt:common:iconpack-tree")
include("sdk:generator:kt:common:ir")
include("sdk:generator:kt:common:util")
include("sdk:generator:kt:common:poet-extensions")
include("sdk:generator:kt:iconpack")
include("sdk:generator:kt:imagevector:common")
include("sdk:generator:kt:imagevector:jvm")
include("sdk:generator:kt:imagevector:kmp")
include("sdk:generator:kt:imagevector:test-fixtures")
