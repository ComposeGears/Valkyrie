...
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.FillAlphaParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.FillParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.NameParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.PathFillTypeParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeAlphaParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeColorParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeLineCapParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeLineJoinParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeLineMiterParam
import io.github.composegears.valkyrie.sdk.generator.kt.imagevector.jvm.util.PathParams.StrokeLineWidthParam
...
private fun CodeBlock.Builder.addLinearGradient(fill: IrFill.LinearGradient) {
    fun gradientBody() {
        ...
        if (config.fullyQualifiedImports.offset) {
            add(
    ...
    if (config.fullyQualifiedImports.brush) {
...
private fun CodeBlock.Builder.addColor(color: IrColor) {
    if (config.fullyQualifiedImports.color) {
    ...
    if (name != null && config.imageVector.useComposeColors) {
