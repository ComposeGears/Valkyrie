        ...
        _FullQualified = ImageVector.Builder(
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to androidx.compose.ui.graphics.Color(0xFF232F34),
                        1f to androidx.compose.ui.graphics.Color(0xFFD80027)
                    ),
                    start = Offset(2f, 2f),
                    end = Offset(6f, 2f)
                )
            ...
            path(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to androidx.compose.ui.graphics.Color.White.copy(alpha = 0.7490196f),
            ...
            path(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                        0.5f to androidx.compose.ui.graphics.Color(0xFFFDE030),
                        0.92f to androidx.compose.ui.graphics.Color(0xFFF7C02B),
                        1f to androidx.compose.ui.graphics.Color(0xFFF4A223)
                    ),
