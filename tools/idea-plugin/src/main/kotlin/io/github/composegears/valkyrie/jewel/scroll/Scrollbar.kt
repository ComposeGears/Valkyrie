...
// Copy sources from Jewel with ScrollbarAdapter
...
@Suppress("ktlint:compose:mutable-state-param-check") // To fix in JEWEL-923
@Composable
private fun Thumb(
    showScrollbar: Boolean,
...
private fun trackColorTween(visibility: ScrollbarVisibility) = tween<Color>(visibility.trackColorAnimationDuration.inWholeMilliseconds.toInt(), easing = LinearEasing)

private fun thumbColorTween(showScrollbar: Boolean, visibility: ScrollbarVisibility) = tween<Color>(
    durationMillis =
    when {
...
private fun verticalMeasurePolicy(sliderAdapter: SliderAdapter, setContainerSize: (Int) -> Unit, thumbThickness: Int) = object : MeasurePolicy {
    ...
    override fun IntrinsicMeasureScope.maxIntrinsicWidth(measurables: List<IntrinsicMeasurable>, height: Int): Int = thumbThickness

    override fun IntrinsicMeasureScope.minIntrinsicWidth(measurables: List<IntrinsicMeasurable>, height: Int): Int = thumbThickness
    ...
    override fun IntrinsicMeasureScope.maxIntrinsicHeight(measurables: List<IntrinsicMeasurable>, width: Int): Int = 0

    override fun IntrinsicMeasureScope.minIntrinsicHeight(measurables: List<IntrinsicMeasurable>, width: Int): Int = 0
}
...
private fun horizontalMeasurePolicy(
    ...
    override fun IntrinsicMeasureScope.maxIntrinsicHeight(measurables: List<IntrinsicMeasurable>, width: Int): Int = thumbThickness

    override fun IntrinsicMeasureScope.minIntrinsicHeight(measurables: List<IntrinsicMeasurable>, width: Int): Int = thumbThickness
    ...
    private fun startScrollingByPage() {
        ...
        job =
            coroutineScope.launch {
                ...
                delay(DELAY_BEFORE_SECOND_SCROLL_ON_TRACK_PRESS.milliseconds)
                while (true) {
                    scrollTowardsCurrentOffset()
                    delay(DELAY_BETWEEN_SCROLLS_ON_TRACK_PRESS.milliseconds)
                }
            }
    }
