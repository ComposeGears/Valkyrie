...
class NewPackViewModel : ViewModel() {
    ...
    private fun saveDestination() {
        val directoryState = currentState.safeAs<ChooseDestinationDirectoryState>() ?: return
    ...
    private fun ValkyriesSettings.toChooseDirectoryState() = ChooseDestinationDirectoryState(
