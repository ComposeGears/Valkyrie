...
class ImageVectorGutterTest : KotlinCodeInsightTest() {
    ...
    @Test
    fun `single gutter icon in file`() {
        runInEdtAndGet {
    ...
    @Test
    fun `multiple gutter icons in file`() {
        runInEdtAndGet {
            myFixture.configureByText(
                "WithoutPathIcons.kt",
                """
    ...
    @Test
    fun `gutter icon with fully qualified Offset in linear gradient`() {
        runInEdtAndGet {
            myFixture.configureByText(
                "FullQualified.kt",
                """
    ...
    @Test
    fun `multiple equal name gutter icons in file`() {
        runInEdtAndGet {
            myFixture.configureByText(
                "Stylus.kt",
                """
